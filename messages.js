const ENGLISH_MESSAGES = Object.freeze({
  ...
  "portal.nav.engineering": "Engineering",
  ...
  "portal.hero.eyebrow": "Developer infrastructure · Product Atlas",
  "portal.hero.titleLead": "Governed tools",
  "portal.hero.titleEmphasis": "for agentic work.",
  "portal.hero.lede":
    "A family of explicit authorities for orchestration, local execution, GitHub effects, semantic views, architecture, interfaces, policy, and remote exposure.",
  "portal.hero.browseProducts": "Explore products",
  "portal.hero.seeEngineering": "Engineering",
  ...
  "portal.products.eyebrow": "01 · Product Atlas",
  "portal.products.title": "One ecosystem. Explicit boundaries.",
  "portal.products.body":
    "Products are organized by the authority they own. Each detail page explains purpose, capability, non-ownership, relationships, engineering evidence, and current work.",
  "portal.product.explore": "Explore {name}",
  "portal.product.github": "GitHub",
  "portal.system.eyebrow": "02 · System",
  "portal.system.title": "Authority stays where it belongs.",
  "portal.system.body":
    "Relationships explain delegation and separation. Adjacency never implies a required runtime dependency.",
  "portal.system.nodes": "Product nodes",
  "portal.system.relationships": "Declared relationships",
  "portal.work.eyebrow": "04 · Current work",
  "portal.work.title": "From product intent to live execution.",
  "portal.work.body":
  ...
  "portal.engineering.pageTitle": "Engineering · yohn-jp",
  "portal.engineering.eyebrow": "03 · Engineering",
  "portal.engineering.title": "Evidence, not decoration.",
  "portal.engineering.body":
    "Measured repository facts and CI evidence, with provenance and explicit gaps. The Pages build never runs consumer test suites.",
  "portal.engineering.homeTitle": "Evidence, not decoration.",
  "portal.engineering.homeBody":
    "A compact view of authoritative repository evidence. Missing values remain visible until a producer emits them.",
  "portal.engineering.productTitle": "Engineering evidence",
  "portal.engineering.productBody":
    "Repository facts and producer evidence, with unavailable data left explicit.",
  "portal.engineering.overview": "Overview",
  "portal.engineering.snapshot": "Current snapshot",
  "portal.engineering.scopeNote":
    "Values carry their collection scope and source. Partial totals include only observed repositories.",
  "portal.engineering.productEvidence": "Product evidence",
  "portal.engineering.atlas": "Across the atlas",
  "portal.engineering.tableNote":
    "Open a product for its role, boundaries, and current work. Inspect rows below for per-field provenance.",
  "portal.engineering.repositoryEvidence": "Repository evidence",
  "portal.engineering.sourceNote":
    "GitHub REST API and the canonical product registry",
  "portal.engineering.snapshotAt": "Snapshot generated",
  "portal.engineering.generated": "Snapshot generated {date}",
  "portal.engineering.open": "Explore Engineering →",
  "portal.engineering.products": "Registered products",
  "portal.engineering.openIssues": "Open Issues",
  "portal.engineering.packageVersion": "Package version",
  "portal.engineering.sourceLoc": "Source LOC",
  "portal.engineering.testLoc": "Test LOC",
  "portal.engineering.sourceFiles": "Source files",
  "portal.engineering.testFiles": "Test files",
  "portal.engineering.coverageLines": "Line coverage",
  "portal.engineering.verificationStatus": "Verification status",
  "portal.engineering.verificationDuration": "Verify duration",
  "portal.engineering.state.available": "Measured",
  "portal.engineering.state.unavailable": "Unavailable",
  "portal.engineering.state.unsupported": "Unsupported",
  "portal.engineering.state.stale": "Stale",
  "portal.engineering.state.partial": "Partial",
  "portal.engineering.state.failed": "Collection failed",
  ...
  "portal.product.recentWork": "Current work",
  "portal.product.noOpenWork":
    "No open Issues in this repository at this snapshot.",
  "portal.product.workUnavailable":
    "Issue collection for this repository is unavailable.",
  ...
  "work.snapshot.loaded": "Snapshot loaded {date}",
  "work.snapshot.updated": "Snapshot updated {date}",
  "work.snapshot.current": "Snapshot is already current.",
  ...
  "work.metrics.increased": "↑ {count}",
  "work.metrics.decreased": "↓ {count}",
  "work.metrics.increasedAria": "increased by {count}",
  "work.metrics.decreasedAria": "decreased by {count}",
  ...
  "work.issue.filterFeedback": "Showing {shown} issues after filters.",
  ...
  "work.refresh.failedFeedback":
    "Refresh failed; the last valid snapshot remains visible.",
...
const JAPANESE_MESSAGES = Object.freeze({
  ...
  "portal.nav.engineering": "エンジニアリング",
  "portal.nav.work": "Work",
  ...
  "portal.locale.english": "English",
  "portal.locale.japanese": "日本語",
  "portal.hero.eyebrow": "開発インフラ · プロダクトアトラス",
  "portal.hero.titleLead": "統制されたツール。",
  "portal.hero.titleEmphasis": "エージェントの仕事へ。",
  "portal.hero.lede":
    "オーケストレーション、ローカル実行、GitHub変更、意味ビュー、アーキテクチャ、インターフェース、ポリシー、リモート公開の権限を明示するプロダクト群。",
  "portal.hero.browseProducts": "プロダクトを見る",
  "portal.hero.seeEngineering": "エンジニアリング",
  ...
  "portal.products.eyebrow": "01 · プロダクトアトラス",
  "portal.products.title": "ひとつのエコシステム。明確な境界。",
  "portal.products.body":
    "各プロダクトを所有する権限で整理しました。詳細ページでは目的、機能、非所有領域、関係、エンジニアリング証拠、現在のWorkを示します。",
  "portal.product.explore": "{name}を詳しく見る",
  "portal.product.github": "GitHub",
  "portal.system.eyebrow": "02 · システム",
  "portal.system.title": "権限は適切な場所に。",
  "portal.system.body":
    "関係は委譲と分離を説明します。隣接していても必須の実行時依存を意味しません。",
  "portal.system.nodes": "プロダクトノード",
  "portal.system.relationships": "宣言された関係",
  "portal.work.eyebrow": "04 · 現在のWork",
  "portal.work.title": "プロダクトの意図から実行中のWorkへ。",
  "portal.work.body":
  ...
  "portal.engineering.pageTitle": "エンジニアリング · yohn-jp",
  "portal.engineering.eyebrow": "03 · エンジニアリング",
  "portal.engineering.title": "証拠を、装飾ではなく。",
  "portal.engineering.body":
    "リポジトリとCIの測定済み証拠を、出所と欠損を明示して示します。Pagesビルドは各プロダクトのテストを実行しません。",
  "portal.engineering.homeTitle": "証拠を、装飾ではなく。",
  "portal.engineering.homeBody":
    "正規のリポジトリ証拠の要約です。生成元が出力するまで欠損値を明示します。",
  "portal.engineering.productTitle": "エンジニアリング証拠",
  "portal.engineering.productBody":
    "リポジトリの事実と生成元の証拠を示し、欠損は明示します。",
  "portal.engineering.overview": "概要",
  "portal.engineering.snapshot": "現在のスナップショット",
  "portal.engineering.scopeNote":
    "値には収集範囲と出所を付けます。部分的な合計は観測できたリポジトリのみを含みます。",
  "portal.engineering.productEvidence": "プロダクトの証拠",
  "portal.engineering.atlas": "アトラス全体",
  "portal.engineering.tableNote":
    "プロダクト詳細で役割、境界、現在のWorkを確認できます。下の行には各値の出所を示します。",
  "portal.engineering.repositoryEvidence": "リポジトリ証拠",
  "portal.engineering.sourceNote":
    "GitHub REST APIと正規プロダクトレジストリー",
  "portal.engineering.snapshotAt": "スナップショット生成日時",
  "portal.engineering.generated": "スナップショット生成日時 {date}",
  "portal.engineering.open": "エンジニアリングを見る →",
  "portal.engineering.products": "登録済みプロダクト",
  "portal.engineering.openIssues": "公開中のIssue",
  "portal.engineering.packageVersion": "パッケージ版",
  "portal.engineering.sourceLoc": "ソース行数",
  "portal.engineering.testLoc": "テスト行数",
  "portal.engineering.sourceFiles": "ソースファイル数",
  "portal.engineering.testFiles": "テストファイル数",
  "portal.engineering.coverageLines": "行カバレッジ",
  "portal.engineering.verificationStatus": "検証状態",
  "portal.engineering.verificationDuration": "検証時間",
  "portal.engineering.state.available": "測定済み",
  "portal.engineering.state.unavailable": "利用不可",
  "portal.engineering.state.unsupported": "非対応",
  "portal.engineering.state.stale": "古いデータ",
  "portal.engineering.state.partial": "一部のみ",
  "portal.engineering.state.failed": "収集失敗",
  ...
  "portal.product.recentWork": "現在のWork",
  "portal.product.noOpenWork":
    "このスナップショットでは公開中のIssueはありません。",
  "portal.product.workUnavailable":
    "このリポジトリのIssue収集は利用できません。",
  ...
  "work.snapshot.loaded": "スナップショットを読み込みました：{date}",
  "work.snapshot.updated": "スナップショットを更新しました：{date}",
  "work.snapshot.current": "スナップショットは最新です。",
  ...
  "work.metrics.increased": "↑ {count}",
  "work.metrics.decreased": "↓ {count}",
  "work.metrics.increasedAria": "{count}件増加",
  "work.metrics.decreasedAria": "{count}件減少",
  ...
  "work.issue.filterFeedback": "フィルター後の表示：{shown}件",
  ...
  "work.refresh.failedFeedback":
    "更新に失敗しました。最後に有効だったスナップショットを表示しています。",
  "work.view.recent": "最近",
