...
test("Japanese catalog translates every governance health message", () => {
  const governanceKeys = [
    ...
    "governance.collection.status.healthy",
    "governance.collection.status.degraded",
    ...
    "governance.repository.collection.healthy",
    "governance.repository.collection.degraded",
    "governance.repository.collection.unavailable",
    "governance.diagnostics.eyebrow",
    "governance.diagnostics.title",
    "governance.diagnostics.empty",
    ...
    "governance.diagnostic.evaluator-failed",
    "governance.diagnostic.repository-source-unavailable",
    "governance.diagnostic.unknown",
